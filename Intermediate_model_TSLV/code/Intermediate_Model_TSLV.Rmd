...
# filtering the burnin phases and replace NA random points TSLV to 365days values (8760 hours), burn-in values
ssfdat.bear.final1 <- ssfdat.bear.final %>% filter(year != "2005") %>% dplyr::mutate(tslv = replace_na(tslv, 8760)) 
