...
2. create a function for calculating TSLV based on the observation  
3. set the burn-in period (a time difference between the initial location time and the current time location) - t index would correlate with the number of observation id 
4. At the end of the TSLV calculation, all the NAs would replace by 354 
6. merge the tslv values to the observed locations 
