...
```{r subset per yr}
# 2015
crane15 <- crane.5c %>% filter(year == "2015")
  
# 2016
crane16 <- crane.5c %>% filter(year == "2016")

# 2017
crane17 <- crane.5c %>% filter(year == "2017")

# 2018
crane18 <- crane.5c %>% filter(year == "2018")

# 2019
crane19 <- crane.5c %>% filter(year == "2019")

# 2020 
crane20 <- crane.5c %>% filter(year == "2020")
```
...
OD15 <- raster(here("data/OD_tif", "OD15.tif"))

# 2016 ODs
OD16 <- raster(here("data/OD_tif", "OD16.tif"))

# 2017 ODs
OD17 <- raster(here("data/OD_tif", "OD17.tif"))

# 2018 ODs
OD18 <- raster(here("data/OD_tif", "OD18.tif"))

# 2019 ODs
OD19 <- raster(here("data/OD_tif", "OD19.tif"))

# 2020 ODs
OD20 <- raster(here("data/OD_tif", "OD20.tif"))
```
...
# 2015
colnames(trk_resample15)[19] <- "nlcd" 

#2016
colnames(trk_resample16)[19] <- "nlcd"
colnames(trk_resample16)[20] <- "OD15"

#2017
colnames(trk_resample17)[19] <- "nlcd"
colnames(trk_resample17)[20] <- "OD15"
colnames(trk_resample17)[21] <- "OD16"
 
#2018
colnames(trk_resample18)[19] <- "nlcd"
colnames(trk_resample18)[20] <- "OD15"
colnames(trk_resample18)[21] <- "OD16"
colnames(trk_resample18)[22] <- "OD17"

#2019
colnames(trk_resample19)[19] <- "nlcd"
colnames(trk_resample19)[20] <- "OD15"
colnames(trk_resample19)[21] <- "OD16"
colnames(trk_resample19)[22] <- "OD17"
colnames(trk_resample19)[23] <- "OD18"

#2020
colnames(trk_resample20)[19] <- "nlcd"
colnames(trk_resample20)[20] <- "OD15"
colnames(trk_resample20)[21] <- "OD16"
colnames(trk_resample20)[22] <- "OD17"
colnames(trk_resample20)[23] <- "OD18"
colnames(trk_resample20)[24] <- "OD19"
```
...
trk_resample16 <- trk_resample16[, c(1:18,20,19)]
trk_resample17 <- trk_resample17[, c(1:18, 20, 21, 19)]
trk_resample18 <- trk_resample18[, c(1:18, 20, 21, 22, 19)]
trk_resample19 <- trk_resample19[, c(1:18, 20, 21, 22, 23, 19)]
trk_resample20 <- trk_resample20[, c(1:18, 20, 21, 22, 23, 24, 19)]
```
...
colnames(summer_trk15)[20] <- 'nlcd_category'
colnames(summer_trk16)[21] <- 'nlcd_category'
colnames(summer_trk17)[22] <- 'nlcd_category'
colnames(summer_trk18)[23] <- 'nlcd_category'
colnames(summer_trk19)[24] <- 'nlcd_category'
colnames(summer_trk20)[25] <- 'nlcd_category'

# nlcd name change
colnames(summer_trk15)[21] <- 'nlcd_name'
colnames(summer_trk16)[22] <- 'nlcd_name'
colnames(summer_trk17)[23] <- 'nlcd_name'
colnames(summer_trk18)[24] <- 'nlcd_name'
colnames(summer_trk19)[25] <- 'nlcd_name'
colnames(summer_trk20)[26] <- 'nlcd_name'
```

## save the extracted resampled trk data
```{r save the data}
# save the filtered resampled trk data with covariates
#write_rds(summer_trk15, path = here("data", "summer_trk15_5c.Rdata"))
#write_rds(summer_trk16, path = here("data", "summer_trk16_5c.Rdata"))
#write_rds(summer_trk17, path = here("data", "summer_trk17_5c.Rdata"))
#write_rds(summer_trk18, path = here("data", "summer_trk18_5c.Rdata"))
#write_rds(summer_trk19, path = here("data", "summer_trk19_5c.Rdata"))
#write_rds(summer_trk20, path = here("data", "summer_trk20_5c.Rdata"))
```
