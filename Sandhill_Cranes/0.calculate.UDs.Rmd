...
```{r subset per yr}
# 2015
crane15 <- crane.5a %>% filter(year == "2015") %>% as.telemetry()

# 2016
crane16 <- crane.5a %>% filter(year == "2016") %>% as.telemetry()

# 2017
crane17 <- crane.5a %>% filter(year == "2017") %>% as.telemetry()

# 2018
crane18 <- crane.5a %>% filter(year == "2018") %>% as.telemetry()

# 2019
crane19 <- crane.5a %>% filter(year == "2019") %>% as.telemetry()

# 2020 
crane20 <- crane.5a %>% filter(year == "2020") %>% as.telemetry()
```
